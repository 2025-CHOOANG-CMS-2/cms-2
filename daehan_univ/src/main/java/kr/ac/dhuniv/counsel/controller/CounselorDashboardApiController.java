...
public class CounselorDashboardApiController {
    ...
    public ResponseEntity<List<ReservationDetailDto>> getDailyReservations(
        ...
        //String counselorEmplNo = authentication.getName();
    ...
    public ResponseEntity<Void> approveReservation(@PathVariable("applyId") Long applyId,
    		Authentication authentication) {
        //String counselorEmplNo = authentication.getName();
    	String counselorEmplNo = "2025110002";
    ...
    public ResponseEntity<Void> rejectReservation(@PathVariable("applyId") Long applyId,
    		Authentication authentication) {
        //String counselorEmplNo = authentication.getName();
    	String counselorEmplNo = "2025110002";
