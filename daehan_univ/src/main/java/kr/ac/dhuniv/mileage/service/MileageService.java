...
public class MileageService {
    ...
    @Transactional
    public void payMileageForProgram(String prgId) {
        ...
        for (NcsCmpInfo cmp : completions) {  //이수 완료 리스트 중에서
            ...
            StdMileageTotal studentTotal = totalRepository.findByStudent_StdNo(student.getStdNo())  //해당 학생의 누적 마일리지 조회
    ...
    private String generateMlgId() {
    	Integer maxId = mileageHistRepository.findMaxMlgIdNumber();
